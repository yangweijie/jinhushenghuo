...
$(function(){
	$('.taber .head a').hover(function(){
		var $current_taber = $(this).closest('.taber');
		$('.body', $current_taber).hide();
		$('.taber #'+$(this).attr('lang')).show();

		$('.head a', $current_taber).removeClass('selected');
...
$(function(){
	$('.topbar .module li').hover(function(){
		...
		//alert($('.topbar').height());
		$('.topbar .droper').css('top',$('.topbar').height()-2);
		$(this).addClass('selected');
	},
	function(){
